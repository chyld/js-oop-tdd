...
describe('Editor', function () {
  ...
  it("allows users to write text", function () {
    ...
    expect(editor.toString()).toEqual("Hello - codez")

    editor.write(" moar")
    expect(editor.toString()).toEqual("Hello - codez moar")
  })
  ...
  it("allows users to undo writes", function () {
    ...
    expect(editor.toString()).toEqual("Hello - codezMoar stuff")
    editor.write("Even more")
    expect(editor.toString()).toEqual("Hello - codezMoar stuffEven more")
  ...
  it("allows users to find and replace", function () {
    ...
    expect(editor.toString()).toEqual("bar stuff other bar")
  })
  ...
  it("allows undo replaces", function () {
    ...
    editor.undo()
    expect(editor.toString()).toEqual("foo stuff other foo")

    editor.undo()
    expect(editor.toString()).toEqual("foo stuff")
  })
